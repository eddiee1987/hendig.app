(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_383b2fe8._.js", {
...
;
;
const toastVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("fixed bottom-4 right-4 z-50 flex items-center justify-between p-4 rounded-md shadow-lg border", {
    variants: {
        variant: {
...
const Toast = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = ({ className, variant, children, onClose, ...props }, ref)=>{
        ...
        "useToast.useCallback[toast]": (options)=>{
            ...
            if (options.duration !== Infinity) {
                setTimeout({
                    "useToast.useCallback[toast]": ()=>{
                        setToasts({
                            "useToast.useCallback[toast]": (currentToasts)=>currentToasts.filter({
                                    "useToast.useCallback[toast]": (toast)=>toast.id !== id
                                }["useToast.useCallback[toast]"])
                        }["useToast.useCallback[toast]"]);
                    }
                }["useToast.useCallback[toast]"], options.duration || 3000);
            }
            return {
                id,
                dismiss: ({
                    "useToast.useCallback[toast]": ()=>setToasts({
                            "useToast.useCallback[toast]": (currentToasts)=>currentToasts.filter({
                                    "useToast.useCallback[toast]": (toast)=>toast.id !== id
                                }["useToast.useCallback[toast]"])
                        }["useToast.useCallback[toast]"])
...
_s(useToast, "OPZKGrTNnwp+klP+pH502F/rcGc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function Toaster() {
    _s();
    const { toasts, setToasts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: toasts.map(({ id, title, description, variant })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toast"], {
                variant: variant,
                onClose: ()=>setToasts((current)=>current.filter((t)=>t.id !== id)),
                children: [
...
_s(Toaster, "WZ3If7ei00XuCQUsDy18sS0PpNo=", false, function() {
    return [
...
//# sourceMappingURL=src_383b2fe8._.js.map