        ...
        "EmployeeProfile.useEffect": ()=>{
            const fetchTimeEntries = {
                "EmployeeProfile.useEffect.fetchTimeEntries": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTimeEntriesByEmployeeId"])(id);
                        setTimeEntries(data);
                    } catch (error) {
                        console.error('Error fetching time entries:', error);
                    } finally{
...
//# sourceMappingURL=src_474a4ad6._.js.map